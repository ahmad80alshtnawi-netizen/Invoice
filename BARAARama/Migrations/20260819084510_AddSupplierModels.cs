...
{
    /// <inheritdoc />
    public partial class AddSupplierModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplyEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplyEntries_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplyEntries_SupplierId",
                table: "SupplyEntries",
                column: "SupplierId");
        }
